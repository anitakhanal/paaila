                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <ul class="topbar-info align-self-end clearfix">
                                    ...
                                    <li><a href="mailto:paaila@mail.com"><i class="fas fa-envelope"></i> paaila@mail.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <nav id="site-navigation" class="main-navigation">
                                        <ul class="menu">
                                            ...
                                            <li class="menu-item-has-children">
                                                <a href="#">Robotics</a>
                                                <ul class="sub-menu">
                                                    <li><a href="about-us.html">Ginger</a></li>
                                                    <li><a href="why-choose-us.html">Pari</a></li>
                                                    <li><a href="our-team.html">Feri</a></li>
                                                    <li><a href="single-team.html">Pari 2.0</a></li>
                                                    <li class="menu-item-has-children"><a href="shop.html">About Robotics</a>
                                            ...
                                            <li>
                                                <a href="portfolio-details-1.html">Careers</a>
                    ...
                    <div class="mmenu_wrapper">
                        <div class="mobile_nav collapse">
                            <ul id="menu-main-menu" class="mobile_mainmenu">
                                ...
                                <li class="menu-item-has-children"><a href="#">Connect with us</a>
                                    <ul class="sub-menu">
                                        <li>Address: jamsikhel</li>
                                        <li>Lalitpur,Kathmandu</li>
                                        <li>Email: info@paailatechnology.com</li>
                                        <li>Phone: +977 015545577</li>
        ...
        <div id="content" class="site-content">
            <div id="rev_slider_one_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="mask-showcase" data-source="gallery">
                ...
                <div id="rev_slider_one" class="rev_slider fullscreenbanner" data-version="5.4.1">
                    <ul>
                        ...
                        <!-- SLIDE 1 -->
                        <li data-index="rs-70" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="../../images/header4.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="../../images/header3.png" data-bgcolor='rgba(255,255,255,0)' style='' alt=""  data-bgposition="50% 50%" data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                            ...
                            <div class="tp-caption tp-resizeme text-light tp-big-text"
                                ...
                                Paaila Technology  <br> <h3>A ROBOTICS & AI COMPANY</h3>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme text-light" 
                                ...
                                data-textAlign="['left','left','left','left']">The power of Robotics to benefit humanity.
                            </div> 
                        ...
                        <li data-index="rs-71" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="https://via.placeholder.com/1920x810.png"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="../../images/header2.jpg" data-bgcolor='#ffffff' style='' alt=""  data-bgposition="50% 50%" data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                            ...
                            <div class="tp-caption tp-resizeme text-light tp-big-text" 
                                ...
                                data-textAlign="['left','left','left','left']">paaila technology </div>
                            ...
                            <div class="tp-caption tp-resizeme text-light" 
                                ...
                                data-textAlign="['left','left','left','left']">We create robot and services that define the role robotics play <br>in our lives today and in the future.</div> 
                        ...
                        <!-- SLIDE 1 -->
                        <li data-index="rs-72" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-thumb="https://via.placeholder.com/
                            x810.png"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="1" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <!-- MAIN IMAGE -->
                            <img src="../../images/header1.jpg" data-bgcolor='#ffffff' alt=""  data-bgposition="50% 50%" data-bgfit="auto" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
            ...
            <div class="padding-half bg-light-1">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ot-heading text-center"><br />
                                <h3 class="main-heading">Companies and people who love us.</h3><br />
                            </div>
                            <div class="partners">
                                    ...
                                    <div>
                                        <a href="#" class="client-logo">
                                            <figure class="partners-slide-inner">
                                                <img class="partners-slide-image" src="../../images/naulo.jpg" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="#" class="client-logo">
                                            <figure class="partners-slide-inner">
                                                <img class="partners-slide-image" src="../../images/sbi.jpg" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="#" class="client-logo">
                                            <figure class="partners-slide-inner">
                                                <img class="partners-slide-image" src="../../images/nloc.jpg" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="#" class="client-logo">
                                            <figure class="partners-slide-inner">
                                                <img class="partners-slide-image" src="../../images/gyani.png" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="#" class="client-logo">
                                            <figure class="partners-slide-inner">
                                                <img class="partners-slide-image" src="../../images/sos.png" alt="">
                                            </figure>
                                        </a>
                                    </div>
                                    <div>
                                        <a href="#" class="client-logo">
                                            <figure class="partners-slide-inner">
                                                <img class="partners-slide-image" src="../../images/sangam.jpg" alt="">
                                            </figure>
                                        </a>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-12 align-self-center">
                            <div class="ot-heading">
                                <h2 class="main-heading">Your Partner for <br> Future Innovation</h2>
                            </div>
                            <p class="mb-15">Paaila Technology is a fast paced company with core focus on Robotics and AI. It comprises of self motivated, talented and hardworking people. In a short span of time, it has delivered products and services to some of the biggest names in the country. The trust of that these companies put in us is a testament to the quality and expertise Paaila delivers in its products and to its clients.</p>
                            <div class="row">
                        ...
                        <div class="offset-lg-1 col-lg-6 col-md-12 align-self-center">
                            <div class="about-right">
                                ...
                                <div class="home-about-video d-flex justify-content-center" style="background-image: url(../../images/team.jpg);">
                                    <div class="video-btn align-self-center">
                                        <a href="https://youtu.be/UKoekhWzqYw" class="btn-play">
                                ...
                                <div class="home-about-btn">
                                    <div class="ot-button">
                                        <a href="about-us.html" class="btn-details"><i class="flaticon-right-arrow-1"></i> LEARN MORE ABOUT US</a>
                                    <div class="space-15"></div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <div class="ot-heading">
                                <span class="text-primary-light">Quality Products from Paaila</span>
                                <h2 class="main-heading text-white">Robots from paaila</h2>
                            </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                            <div class="serv-box-2 s2">
                                ...
                                <div class="content-box">
                                    <div><img src="../../images/robot1.png" /></div>
                                    <center><a href="it-services.html" class="btn-details" style="font-size: 20px">Ginger - Waiter Robot</a></center>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                            <div class="serv-box-2 s2">
                                ...
                                <div class="content-box"> 
                                    <div>
                                        <div><img src="../../images/robot2.png" /></div>
                                    </div>
                                    <center><a href="web-development.html" class="btn-details"  style="font-size: 20px">Pari 2.0</a></center>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                            <div class="serv-box-2 s2">
                                ...
                                <div class="content-box">
                                    <div><img src="../../images/robot3.png" /></div>
                                    <center><a href="it-services.html" class="btn-details" style="font-size: 20px">Chat Robot</a></center>
                                </div>
                            </div>
                        </div>
            ...
            <section class="pt-0 pb-290" style="padding-bottom: 150px">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8 mb-4 mb-sm-0">
                            <div class="ot-heading mb-0">
                                ...
                                <h2 class="main-heading">Helping your business leverage <br>the power of AI</h2>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="ot-heading">
                                <span>Artificial Intelligence Services</span>
                                <h2 class="main-heading">Helping your business leverage the power of AI</h2>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <p class="mb-0">The world is rapidly embracing AI and reaping its' benefits. Paaila Technology wants to help companies in Nepal integrate AI technologies in their business.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="owl-carousel owl-theme project-slider">
                        ...
                        <div class="projects-box">
                            <div class="projects-thumbnail">
                                <a href="portfolio-details-1.html">
                                    <img src="../../images/service1.png" class="" alt="">                         
                            ...
                            <div class="portfolio-info ">
                                <div class="portfolio-info-inner">
                                    ...
                                    <h5><a href="portfolio-details-1.html">Nepali Speech Recognition</a></h5>
                    ...
                    <div class="project-item projects-style-2">
                        <div class="projects-box">
                            <div class="projects-thumbnail">
                                <a href="portfolio-details-1.html">
                                    <img src="../../images/service2.jpg" class="" alt="">                         
                                    <span class="overlay"></span>
                                </a>
                            </div>
                            <div class="portfolio-info ">
                                <div class="portfolio-info-inner">
                                    <a class="btn-link" href="htportfolio-details-1.html"><i class="flaticon-right-arrow-1"></i></a>
                                    <h5><a href="portfolio-details-1.html">Query-AI powered chatbot</a></h5>
                    ...
                    <div class="project-item projects-style-2">
                        <div class="projects-box">
                            <div class="projects-thumbnail">
                                <a href="portfolio-details-1.html">
                                    <img src="../../images/service3.png" class="" alt="">                         
                                    <span class="overlay"></span>
                                </a>
                            </div>
                            <div class="portfolio-info ">
                                <div class="portfolio-info-inner">
                                    <a class="btn-link" href="htportfolio-details-1.html"><i class="flaticon-right-arrow-1"></i></a>
                                    <h5><a href="portfolio-details-1.html">Nepali Text To Speech</a></h5>
            ...
            <section class="technology-v1 no-padding">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ot-heading text-center">
                                <span>Paaila in News!</span>
                                <h2 class="main-heading">Media coverage</h2>
                            </div>
                        </div>
                    </div>
                    <div class="space-15"></div>
                    <div class="row">
                        <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                            <a class="tech-box text-center" href="web-development.html" target="_blank">
                                <div class="icon-main"><img src="../../images/xinhua.png" height="200" width="200" /></div>
                                <h5>WEB</h5>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                            <a class="tech-box text-center" href="mobile-development.html">
                                <div class="icon-main"><img src="../../images/msn.png" height="200" width="200" /></div>
                                <h5>Android</h5>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                            <a class="tech-box text-center" href="mobile-development.html">
                                <div class="icon-main"><img src="../../images/afp.png" height="200" width="200" /></div>
                                <h5>IOS</h5>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                            <a class="tech-box text-center" href="it-services.html">
                                <div class="icon-main"><img src="../../images/indiatoday.png" height="200" width="200" /></div>
                                <h5>IOT</h5>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                            <a class="tech-box text-center" href="it-services.html">
                                <div class="icon-main"><img src="../../images/south-china.png" height="200" width="200" /></div>
                                <h5>Wearalables</h5>
                            </a>
                        </div>
                        <div class="col-lg-2 col-md-4 col-sm-6 col-12">
                            <a class="tech-box text-center" href="it-services.html">
                                <div class="icon-main"><img src="../../images/start.png" height="200" width="200" /></div>
                                <h5>TV</h5>
                            </a>
                        </div>

                        <div class="ot-button">
                            <a href="about-us.html" class="btn-details" style="align-content: center"><i class="flaticon-right-arrow-1"></i> LEARN MORE ABOUT US</a>
                        </div>
                    </div>
                </div>
            </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="widget-footer">
                        ...
                        <ul class="list-items">
                            <li class="list-item">
                            <li class="list-item">Address: jamsikhel</li>
                            <li class="list-item">Lalitpur,Kathmandu</li>
                            <li class="list-item">Email: info@paailatechnology.com</li>
                            <li class="list-item">Phone: +977 015545577</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="widget-footer">
                        <h5 class="text-white">Robotics</h5>
                        <ul class="list-items">
                            <li class="list-item"><a href="it-services.html">Pari 2</a></li>
                            <li class="list-item"><a href="it-services.html">Waiter Robot</a></li>
                            <li class="list-item"><a href="it-services.html">Room Service Robot</a></li>
                            <li class="list-item"><a href="it-services.html">Pari</a></li>
                            <li class="list-item"><a href="it-services.html">FAQ on Pari</a></li>
                            <li class="list-item"><a href="it-services.html">Pari in Images</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="widget-footer">
                        <h5 class="text-white">AI</h5>
                        <ul class="list-items">
                            <li class="list-item"><a href="about-us.html">Nepali Speech Recognition</a></li>
                            <li class="list-item"><a href="faq.html">Nepali Text to Speech</a></li>
                            <li class="list-item"><a href="blog.html">Question Answering System</a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="widget-footer">
                        ...
                        <ul class="list-items">
                            <li class="list-item"><a href="about-us.html">Vision</a></li>
                            <li class="list-item"><a href="faq.html">The Team</a></li>
                            <li class="list-item"><a href="blog.html">Media Coverage</a></li>
                            <li class="list-item"><a href="blog.html">Awards</a></li>
            ...
            <div class="row mt-65">
                <div class="col-md-6 mb-4 mb-md-0">
                    <img src="../../images/logo.png" alt="" class="lazyloaded" data-ll-status="loaded">
                </div>
                <div class="col-md-6 text-left text-md-right align-self-center">
                    <p class="copyright-text">Copyright © Paaila. All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </footer><!-- #site-footer -->
